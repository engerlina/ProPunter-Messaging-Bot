...
const weeklyPrompts = {
  ...
  Saturday: "Day 6 (Saturday): Big Race Day Bonanza Tactic: Offer a limited-time discount for the weekly plan to entice users to experience the premium channel during the biggest race day. Example Post: 🎉 SATURDAY SPECIAL 🎉: Dive into today's 20+ races with our expert tips! Get 50% off our Galloping Gains Weekly plan for today only! Experience the thrill of premium betting. Use code: SATBONANZA at checkout. Add the membership bot @ProPunter_bot and use the /subscribe command",
